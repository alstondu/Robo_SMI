// Generated by gencpp from file cw1_team_10/exampleRequest.msg
// DO NOT EDIT!


#ifndef CW1_TEAM_10_MESSAGE_EXAMPLEREQUEST_H
#define CW1_TEAM_10_MESSAGE_EXAMPLEREQUEST_H
...
struct exampleRequest_
{
  ...
  typedef boost::shared_ptr< ::cw1_team_10::exampleRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::cw1_team_10::exampleRequest_<ContainerAllocator> const> ConstPtr;

}; // struct exampleRequest_

typedef ::cw1_team_10::exampleRequest_<std::allocator<void> > exampleRequest;

typedef boost::shared_ptr< ::cw1_team_10::exampleRequest > exampleRequestPtr;
typedef boost::shared_ptr< ::cw1_team_10::exampleRequest const> exampleRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::cw1_team_10::exampleRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::cw1_team_10::exampleRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::cw1_team_10::exampleRequest_<ContainerAllocator1> & lhs, const ::cw1_team_10::exampleRequest_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::cw1_team_10::exampleRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cw1_team_10::exampleRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::cw1_team_10::exampleRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::cw1_team_10::exampleRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cw1_team_10::exampleRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cw1_team_10::exampleRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::cw1_team_10::exampleRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::cw1_team_10::exampleRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x16f08f6abcc9049eULL;
  static const uint64_t static_value2 = 0x818ebd0c826029fcULL;
};

template<class ContainerAllocator>
struct DataType< ::cw1_team_10::exampleRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::cw1_team_10::exampleRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::cw1_team_10::exampleRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::cw1_team_10::exampleRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::cw1_team_10::exampleRequest_<ContainerAllocator>& v)
  {
...
#endif // CW1_TEAM_10_MESSAGE_EXAMPLEREQUEST_H
