...
if("TRUE" STREQUAL "TRUE")
  set(rpl_panda_with_rs_SOURCE_PREFIX /home/alston/UCL-COMP0129-LAB/src/rpl_panda_with_rs)
  set(rpl_panda_with_rs_DEVEL_PREFIX /home/alston/UCL-COMP0129-LAB/devel/.private/rpl_panda_with_rs)
  ...
  set(rpl_panda_with_rs_INSTALL_PREFIX /home/alston/UCL-COMP0129-LAB/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rpl_panda_with_rs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alston/UCL-COMP0129-LAB/src/rpl_panda_with_rs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/alston/UCL-COMP0129-LAB/devel/.private/rpl_panda_with_rs/lib;/home/alston/UCL-COMP0129-LAB/devel/lib;/opt/ros/noetic/lib)
